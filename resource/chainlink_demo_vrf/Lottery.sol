...
contract Lottery is ChainlinkClient {
    ...
    {
        setPublicChainlinkToken(); // TODO what does it do?
        lotteryId = 1;
  ...
  function start_new_lottery(uint256 duration) public {
    ...
    Chainlink.Request memory req = buildChainlinkRequest(CHAINLINK_ALARM_JOB_ID, address(this), this.fulfill_alarm.selector); // TODO what's .selector?
